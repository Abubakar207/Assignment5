...
public final class ActivityTabBinding implements ViewBinding {
  ...
  private ActivityTabBinding(@NonNull CoordinatorLayout rootView, @NonNull TabLayout tabs,
  ...
  public static ActivityTabBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTabBinding((CoordinatorLayout) rootView, tabs, title, viewPager);
    }
